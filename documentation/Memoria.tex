...
\end{itemize}
Estos subojetivos se cumplirán con su implementación en un módulo software que además estará disponible en una aplicación web \citep{tweetscweb}.
...
En esta sección se explica el análisis que se ha realizado para la construcción de este proyecto junto con la solución propuesta.
...
\subsection{Cómo usarlo}\label{sec:readmegithub}
...
\section{Conclusiones y vías futuras}\label{conclusionesyviasfuturas}
